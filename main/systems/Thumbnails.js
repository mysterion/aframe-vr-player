import { THUMB_ERROR, THUMB_LOADING, FILE_GET_URL, THUMB_URL } from "../components/Consts.js";
import { trimJoin } from "../utils.js";
...
AFRAME.registerSystem(THUMBNAILS, {
    ...
    processSrc: function () {
        ...
        this.current = trimJoin(THUMB_URL, this.src.replace(new RegExp(`^.*${FILE_GET_URL}`), ""))
